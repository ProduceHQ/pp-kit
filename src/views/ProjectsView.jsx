...
import { downloadKitXlsx } from '../lib/xlsxExport';
        ...
        {visibleProjects.map(project => {
          ...
          return (
            <div key={project.id} className="pc" style={{ opacity: isReturned ? 0.7 : 1 }}>
              ...
              {/* Meta */}
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, color: 'var(--tx-dim)', fontSize: 11, marginBottom: 12 }}>
              ...
              <div style={{ marginBottom: 14 }}>
                {isConfirming ? (
                  ...
                  <div style={{ display: 'flex', gap: 7, flexWrap: 'wrap' }}>
                    ...
                    <button className="bo" onClick={() => downloadKitXlsx(project, inventory)}>
                      Sheets
                    </button>
